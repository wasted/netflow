...
sealed class NetFlowV6 extends CassandraTable[NetFlowV6, NetFlowV6Record] {
   ...
   */
  def apply(sender: InetSocketAddress, buf: ByteBuf, uptime: Long, timestamp: DateTime): Option[NetFlowV6Record] = Try[NetFlowV6Record] {
...
case class NetFlowV6Record(sender: InetSocketAddress, length: Int, uptime: Long, timestamp: DateTime,
                           ...
                           snmpInput: Int, snmpOutput: Int, srcMask: Int, dstMask: Int) extends NetFlowData[NetFlowV6Record] {
